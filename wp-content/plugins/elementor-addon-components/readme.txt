...
* PHP version 7.4 Recommended PHP version 8.1 or greater
...
= V2.3.0 - 12/31/2024 =
* New: ACF field type 'Image gallery' for managing a collection of images.
...
* Improve: Compatibility with Wordpress 6.0
...
* Improve: Compatibility with Elementor 3.6.0
...
* Improve: Verification of security nonces.
...
* Improve: Compatibility with Wordpress 5.9.0
...
* Improve: Security of translated strings on output.
* Improve: Compatibility with Elementor 3.5.0
...
* Improve: Loading style sheet files.
...
* Improve: Compatibility with Wordpress 5.8.1
* Improve: Compatibility with Elementor 3.4.6
* Notice: After the update, do not forget to clean your browser cache.
* Improve: The security of the plugin configuration page.
