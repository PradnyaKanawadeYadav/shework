...
class Mega_Menu_Widget extends Widget_Base {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'selectors'      => array(
						'{{WRAPPER}} .eac-mega-menu.menu-fixed .inside-container' => 'font-size: {{SIZE}}%;',
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					array(
						...
						'selectors'      => array(
							'{{WRAPPER}} .woocommerce-mini-cart__buttons .button' => 'inline-size: {{SIZE}}{{UNIT}};',
						),
					)
				);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .mega-menu_top-link .mega-menu_item-title,
						{{WRAPPER}} .mega-menu_top-link .icon-menu-toggle,
						{{WRAPPER}} .mega-menu_top-link i,
						{{WRAPPER}} .mega-menu_top-link .eac-shopping-cart,
						{{WRAPPER}} .mega-menu_top-link .eac-shopping-cart i' => 'color: {{VALUE}};',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						{{WRAPPER}} .mega-menu_top-item:hover .mega-menu_top-link i,
						{{WRAPPER}} .mega-menu_top-item:hover .mega-menu_top-link .icon-menu-toggle svg,
						{{WRAPPER}} .mega-menu_top-item:hover .mega-menu_top-link .eac-shopping-cart svg' => 'color: {{VALUE}}; fill: {{VALUE}};',
					),
				)
			);
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'       => '{{WRAPPER}} .mega-menu_top-link .mega-menu_item-title,
										{{WRAPPER}} .mega-menu_top-link i,
										{{WRAPPER}} .mega-menu_top-link .icon-menu-toggle',
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						{{WRAPPER}} .mega-menu_nav-toggle,
						{{WRAPPER}} .mega-menu_nav-wrapper.breakpoint .inside-container' => 'background-color: {{VALUE}};',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						{{WRAPPER}} .woocommerce-mini-cart .mini_cart_item:hover .quantity,
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .mega-menu_nav-wrapper,
						{{WRAPPER}} .mega-menu_nav-wrapper .mega-menu_top-item' => 'inline-size: {{SIZE}}{{UNIT}};',
					),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'global'    => array( 'default' => Global_Colors::COLOR_TEXT ),
					'selectors' => array(
						'{{WRAPPER}} .mega-menu_sub-link .mega-menu_item-title,
						{{WRAPPER}} .mega-menu_sub-link .icon-menu-toggle,
						{{WRAPPER}} .mega-menu_sub-link i,
						{{WRAPPER}} .mini-cart-product .mini_cart_item *:not(.remove_from_cart_button),
						{{WRAPPER}} .mini-cart-product .woocommerce-mini-cart__total' => 'color: {{VALUE}};',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						{{WRAPPER}} .mega-menu_sub-item:hover .mega-menu_item-title i,
						{{WRAPPER}} .mega-menu_sub-item:hover .icon-menu-toggle i,
						{{WRAPPER}} .mega-menu_sub-item:hover .icon-menu-toggle svg,
						{{WRAPPER}} .mega-menu_sub-menu:hover .mini_cart_item *:not(.remove_from_cart_button)' => 'color: {{VALUE}}; fill: {{VALUE}};',
					),
				)
			);
			...
			$this->add_group_control(
				...
				array(
					...
					'selector'       => '{{WRAPPER}} .mega-menu_sub-link .mega-menu_item-title,
										{{WRAPPER}} .mega-menu_sub-link i, 
										{{WRAPPER}} .mega-menu_sub-link .icon-menu-toggle',
				)
			);
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .mega-menu_sub-menu' => 'inline-size: {{SIZE}}{{UNIT}};',
					),
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .mega-menu_sub-menu .mega-menu_sub-menu' => 'inline-size: {{SIZE}}{{UNIT}};',
					),
					'condition'  => array( 'mn_content_display' => 'default' ),
				)
			);
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				array(
					...
					'toggle'         => false,
					'selectors'      => array(
						'{{WRAPPER}} .mega-menu_menu-icon, {{WRAPPER}} .mega-menu_menu-icon' => 'justify-content: {{VALUE}};',
					),
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '#FFFFFF',
					'selectors' => array(
						'{{WRAPPER}} .mega-menu_menu-icon, {{WRAPPER}} .mega-menu_menu-icon i, {{WRAPPER}} .toggle-menu' => 'color: {{VALUE}};',
					),
				)
			);
	...
	protected function render_megamenu() {
		...
		$args = array(
			...
			'items_wrap'      => '<ul id="%1$s" class="%2$s" role="menubar" aria-label="' . esc_attr( $current_menu_label ) . '" aria-orientation="' . $orientation . '">%3$s</ul>',
			'echo'            => false,
		...
		$this->add_render_attribute( 'nav-menu', 'aria-label', esc_html( $current_menu_label ) );
		...
		if ( '(max-width:240px)' !== $settings['mn_settings_responsive_breakpoint'] ) {
			?>
		<button <?php $this->print_render_attribute_string( 'button-open' ); ?>>
		...
		<button <?php $this->print_render_attribute_string( 'button-close' ); ?>>
			<div class='mega-menu_menu-icon eac-icon-svg'>
