...
class Eac_Acf_Lib {
	...
	public function __construct() {
		/** Charge le trait pour corriger la méthode 'print_panel_template' */
		include_once __DIR__ . '/tags/traits/panel-template.php';
		/** Charge le trait pour calculer l'ID courant du post/template */
		include_once __DIR__ . '/tags/traits/post-main-id.php';
		/** @since 2.3.2 Ajout des champs par défaut des balises dynamiques ACF */
		include_once __DIR__ . '/tags/traits/default-field-trait.php';
