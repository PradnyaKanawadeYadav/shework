...
class WC_Product_Grid_Widget extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		if ( Eac_Config_Elements::is_a_block_theme() ) {
			...
			wp_register_script( 'eac-post-grid', EAC_Plugin::instance()->get_script_url( 'assets/js/elementor/eac-post-grid' ), array( 'jquery', 'elementor-frontend', 'swiper-bundle', 'isotope', 'eac-imagesloaded', 'eac-infinite-scroll' ), EAC_PLUGIN_VERSION, true );
		}
		...
		wp_register_style( 'eac-product-grid', EAC_Plugin::instance()->get_style_url( 'assets/css/wc-product' ), array( 'eac-post-grid' ), EAC_PLUGIN_VERSION );
	...
	public function get_script_depends(): array {
		if ( Eac_Config_Elements::is_a_block_theme() ) {
			return array( 'swiper-bundle', 'isotope', 'eac-imagesloaded', 'eac-infinite-scroll' );
		} else {
			return array( 'swiper-bundle', 'isotope', 'eac-imagesloaded', 'eac-infinite-scroll', 'eac-post-grid' );
		}
	}
					...
					<article id="<?php echo 'post-' . esc_attr( $product_id ); ?>" class="<?php echo esc_attr( $post_class ); ?>">
						<div <?php $this->print_render_attribute_string( 'inner_wrapper' ); ?>>
							...
							<?php if ( $has_promo && $product->is_on_sale() && ! $is_a_catalog ) : ?>
								...
								<?php endif; ?>
							</div> <!-- Fin al-post__content-wrapper -->
	...
	public function force_load_script_for_fse() {
		wp_enqueue_script( 'eac-post-grid', EAC_Plugin::instance()->get_script_url( 'assets/js/elementor/eac-post-grid' ), array( 'jquery' ), EAC_PLUGIN_VERSION, true );
	}
