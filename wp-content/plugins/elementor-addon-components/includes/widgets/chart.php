...
class Chart_Widget extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_script( 'eac-chart', EAC_Plugin::instance()->get_script_url( 'assets/js/elementor/eac-chart' ), array( 'jquery', 'elementor-frontend', 'chart-src', 'chart-color', 'chart-label', 'chart-style' ), EAC_PLUGIN_VERSION, true );
	...
	protected function render_chart( $datajson ) {
		...
		<div <?php $this->print_render_attribute_string( 'chart_wrapper' ); ?>>
			...
			<div id='chart__wrapper-swap' class='chart__wrapper-swap eac-icon-svg'  aria-label='<?php echo esc_html__( 'Inverser les axes', 'eac-components' ); ?>' tabindex='0'>
				<?php
				Icons_Manager::render_icon(
					array(
