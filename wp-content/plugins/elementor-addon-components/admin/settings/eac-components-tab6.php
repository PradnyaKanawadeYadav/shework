...
$second                   = esc_html__( "La page 'Panier' sera vidée de ses items", 'eac-components' );
		...
		<div class='eac-settings-tabs'>
			<div class='eac-elements__table-common wc'>
				...
				<div class="<?php echo esc_attr( $class_wrapper_config ); ?>">
					<span class='info'><?php esc_html_e( 'Pour une parfaite intégration de la grille de produits dans votre site vitrine, vous devez définir le comportement des liens, boutons et pages WooCommerce', 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_select ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Sélectionner la page produit', 'eac-components' ); ?></span>
					...
					<span class='info'><?php esc_html_e( "La page que vous avez créée avec le composant 'WC Grille de produits'", 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_catalog ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Catalogue', 'eac-components' ); ?>
					...
					<span class='info'><?php esc_html_e( "Transforme la vitrine en catalogue de produits sans possibilité d'achat", 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_request ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Demander un devis', 'eac-components' ); ?></span>
					<span>
						<label class='switch'>
					...
					<span class='info'><?php esc_html_e( 'Affiche un message dans la page du produit pour demander un devis', 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_pages ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Rediriger les URLs des pages', 'eac-components' ); ?></span>
					<span>
						<label class='switch'>
				...
				<div class="<?php echo esc_attr( $class_wrapper_redirect ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Rediriger les URLs des boutons', 'eac-components' ); ?></span>
					<span>
						<label class='switch'>
					...
					<span class='info'><?php esc_html_e( "Les boutons 'Retourner à la vitrine' et 'Continuer les achats' de la page panier seront redirigés vers la page sélectionnée dans la liste", 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_breadcrumb ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( "Rediriger le fil d'ariane", 'eac-components' ); ?></span>
					<span>
						<label class='switch'>
					...
					<span class='info'><?php esc_html_e( "L'URL 'catégorie' du fil d'ariane de la page produit sera redirigé vers la page sélectionnée dans la liste", 'eac-components' ); ?></span>
				</div>

				<div class="<?php echo esc_attr( $class_wrapper_metas ); ?>">
					<span class='eac-elements__item-content'><?php esc_html_e( 'Rediriger les URLs des balises metas', 'eac-components' ); ?></span>
					<span>
						<label class='switch'>
					...
					<span class='info'><?php esc_html_e( 'Les URLs des balises metas de la page produit seront redirigés vers la page sélectionnée dans la liste', 'eac-components' ); ?></span>
				</div>
